<script>
    ...
    $: {
        ...
        if ($data?.targetData?.team == 0) {
            document.getElementById("focs-boost").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#fff";
            document.getElementById("goals-icon").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("saves-icon").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("assists-icon").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("shots-icon").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("score-text").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("focused-name").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#fff";
            document.getElementById("goals").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("assists").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("saves").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("shots").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
            document.getElementById("score").style.fill =
                $panelData.blueOverride != ""
                    ? $panelData.blueOverride
                    : "#000";
        }
...
<main>
    <div
        id="outer-focs"
        class="outer-focs"
        style="opacity: {!$isInGame || $isReplay || $stingerBool
            ? 0
        ...
        >
            <defs>
                ...
                >
                    <stop
                        offset="0"
                        stop-color={$data?.targetData?.team == 0
                            ? $panelData.blueColor
                            : $data?.targetData?.team == 1
                            ? $panelData.orngColor
                            : "#ffffff00"}
                    />
                    <stop
                        offset="1"
                        stop-color={$data?.targetData?.team == 0
                            ? $panelData.blueColor2
                            : $data?.targetData?.team == 1
                            ? $panelData.orngColor2
                            : "#ffffff00"}
                    />
                </linearGradient>
                <linearGradient
                    id="focs-boost-gradient"
                    x1="2"
                    y1="99.65"
                    x2="582.26"
                    y2="99.65"

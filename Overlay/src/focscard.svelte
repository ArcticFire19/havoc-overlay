...
<main>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" transform="translate(-9 , 960)" xmlns:xlink="http://www.w3.org/1999/xlink" width="498" height="72" viewBox="0 0 498 74">
        <defs>
          ...
          <clipPath id="focs-boost-clip">
            <rect id="boost-rect"  x="2" y="75" width="{$data?.targetData?.boost
                ? Math.trunc(
                      $data?.targetData?.boost * 0.01 * 580
                  ).toString()
                : "50"}"
                height="40"/>
          </clipPath>
        ...
        <g id="Layer_2" data-name="Layer 2">
            <g id="focused-card">
                ...
                <text id="goals" transform="translate(328.56 50.94)" dominant-baseline="middle" text-anchor="middle" style="font-size: 17.5px;font-family: Arial-Black, Arial;font-weight: 800">{$data?.targetData?.goals ?? ""}</text>
                ...
                <text transform="translate(265.66 24.91)" style="font-size: 10px;font-family: IntegralCF-Regular, Integral CF">Score</text>
